...
export default function HeaderSearch({ open, onClose, menuData = [] }) {
    ...
    // if (!open) {
    //     return (
    //         <div className="flex items-center w-3/4 rounded-md px-3 py-2 border border-dashed border-slate-300 text-sm">
    ...
    return (
        <div className="relative w-full">
            <div className="w-4/4 mx-auto text-start">
                ...
                </form> : <div className="flex items-center w-3/4 rounded-md px-3 py-2 border border-dashed border-slate-300 text-sm">
                    <Truck className="mr-2 h-4 w-4 text-red-800" />
                    <p className="text-red-800">Only Ready To Ship Products</p>
                </div>}
            </div>
