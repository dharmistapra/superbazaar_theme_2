...
const Accountlayouttheme2 = ({ children }) => {
    ...
    return (
        <div className="container mx-auto px-4 mt-7 mb-10 md:flex">
                ...
                {tabs.map((tab) => {
                    ...
                    if (tab.onClick) {
                        return (
                            <li key={tab.name}>
                                <button
                                    onClick={tab.onClick}
                                    className="group inline-flex items-center px-3 py-3 w-full border-b border-gray-300 text-zinc-900 hover:bg-zinc-900 hover:text-white hover:border-zinc-900"
                                >
                    ...
                    return (
                        <li key={tab.name}>
                            <Link
                                href={tab.href}
                                className={`group inline-flex items-center px-3 py-3 w-full border-b ${isActive
